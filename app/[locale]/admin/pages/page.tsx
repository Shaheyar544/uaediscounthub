...
import { 
  Plus, Search, Edit3, Trash2, FileCode, CheckCircle, 
  XCircle, Loader2, Save, X, Eye, ExternalLink
} from 'lucide-react'
...
export default function PagesManagementPage({ params }: { params: { locale: string } }) {
  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link 
          href={`/${params.locale}/admin/pages/new`}
                  ...
                  <tr key={page.id} className="border-b border-[#DDE3EF] last:border-none hover:bg-[#F6F8FC] transition-colors">
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-1.5">
                        ...
                        <Link href={`/${params.locale}/${page.slug}`} target="_blank" className="text-[#8A94A6] hover:text-[#0057FF]">
                    ...
                    <td className="p-4 text-right">
                      <div className="flex items-center justify-end gap-1">
                        <Link 
                          href={`/${params.locale}/admin/pages/${page.id}/edit`}
